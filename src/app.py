...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training, drills, and matches on the school field",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, teamwork, and play friendly games",
    ...
    "Art Studio": {
        ...
        "max_participants": 14,
        "participants": ["sophia@mergington.edu", "noelle@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, perform skits, and build theatrical skills",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "lucy@mergington.edu"]
    },
    "Science Club": {
...
_ACTIVITY_BASELINE = deepcopy(activities)


def reset_activities():
    global activities
    activities = deepcopy(_ACTIVITY_BASELINE)
